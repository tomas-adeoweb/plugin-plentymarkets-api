...
class FindologicServiceProvider extends ServiceProvider
{
    ...
    {
        $this->getApplication()->register('\Findologic\Ceres\Providers\FindologicRouteServiceProvider');
    }
    ...
    public function boot(
        ...
        $this->getLoggerObject()->warning('Add Findologic');
        $this->getLoggerObject()->critical('Add Findologic');
        $this->getLoggerObject()->error('Add Findologic');
